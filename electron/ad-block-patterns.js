...
function shouldBlockWebPopup(payload) {
  ...
  // User explicitly allowed pop-ups for this opener (address bar chip or menu) — honor it
  // before streaming heuristics, otherwise the save never affects cross-origin opens.
